	...
	return (
		...
		>
			...
			<Text color="gray.600" mb={4}>
				Choose from your published scenario revisions.
			</Text>
			...
			{assignments.length === 0 ? (
				<EmptyState
					...
					description="Students cannot access a simulation until one is assigned. Choose a published revision above to make it available to this class."
				/>
			) : (
				assignments.map((item) => (
					...
					>
						<Box>
							<Text fontWeight="semibold">{item.scenario_name}</Text>
