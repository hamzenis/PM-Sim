import { Alert, AlertIcon, Box, Button, Container, Heading, Spinner, Stack } from '@chakra-ui/react';
...
import SimulationDashboard from '../components/SimulationV2/SimulationDashboard';
...
const SimulationV2 = () => {
	...
	return (
		<Container maxW="6xl" py={8}>
			...
			<SimulationDashboard state={state} turns={turns} />
