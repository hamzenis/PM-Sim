...
const Simulation = () => {
	...
	// current simulation type (eg. question, segment, event)
												...
												(simValues.tasks.tasks_bug +
													...
													<Button
														onClick={() => {
															if (
																window.confirm(
																	'Are you sure you want to deliver the Project?'
																)
															) {
																manualEndSimulation();
															}
													...
													<>
														<Button colorScheme="blue" size="lg" mt={3}>
															<Link to={{ pathname: '/' }}>
																<Tooltip
																	label={
																		'Finish the simulation and go back to the scenario overview.'
																	}
																	aria-label="A tooltip"
																	placement="top"
																>
