...
All commands in this document run from `backend_v2`.
...
The parity fixtures are intentional compatibility records. Update them only after reviewing and
documenting a simulation behavior change.
