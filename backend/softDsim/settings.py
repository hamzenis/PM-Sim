...
# DEBUG Vars for easy access
# Use DEBUG_MODE to toggle debug settings in other files
# Use DEBUG_DIRECTORY to set the directory for debug outputs, like CSVs
DEBUG = True
DEBUG_MODE = DEBUG
DEBUG_DIRECTORY = Path(__file__).resolve().parent.parent.parent / "temp_outputs"
